            ...
            <Card classname="w-screen grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                ...
                {techStack[type].map((el, index) => (
                    <motion.div
                        ...
                        className="mx-auto py-2 px-4 bg-gray-50 md:m-4 md:mx-2 mt-6 rounded-lg flex items-center hover:scale-125 hover:duration-300 cursor-pointer md:w-48 w-44 h-16"
                    >
                        <Image
                            alt=""
                            src={el.link}
