        ...
        <div className="h-full md:h-screen mt-16 flex flex-col md:flex-row bg-[#050816] relative ">
            ...
            <div className="h-screen flex flex-col justify-center w-screen md:w-1/2 md:m-5 text-white items-center relative z-10">
                <div className='flex flex-col px-1'>
                    ...
                    <p className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-semibold mt-3">I am a <span className=" underline rounded-xl px-2">Web Developer</span> </p>
                    <button className='gap-2 px-3 py-1.5 flex items-center justify-center bg-violet-500 rounded-xl mt-8 w-2/3 lg:w-1/2 h-10 md:h-12
                    text-md
